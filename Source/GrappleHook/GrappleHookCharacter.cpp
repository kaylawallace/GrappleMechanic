...
AGrappleHookCharacter::AGrappleHookCharacter()
{
...
void AGrappleHookCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGrappleHookCharacter::Move);
...
void AGrappleHookCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
